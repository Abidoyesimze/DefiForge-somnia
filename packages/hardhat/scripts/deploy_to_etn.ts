...
async function main() {
  console.log("🚀 Deploying DefiForge Contracts to ETN Testnet...\n");
  ...
  if (balance < ethers.parseEther("0.1")) {
    console.log("⚠️  WARNING: Low ETN balance. You might need more for gas fees.");
  }
  ...
  try {
    ...
    console.log(`🔗 Explorer: https://testnet-explorer.electroneum.com/address/${erc20FactoryAddress}\n`);
    ...
    console.log(`🔗 Explorer: https://testnet-explorer.electroneum.com/address/${erc721FactoryAddress}\n`);
    ...
    console.log(`🔗 Explorer: https://testnet-explorer.electroneum.com/address/${erc1155FactoryAddress}\n`);
    ...
    console.log(`🔗 Explorer: https://testnet-explorer.electroneum.com/address/${defiUtilsAddress}\n`);
    ...
    console.log(`🔗 Explorer: https://testnet-explorer.electroneum.com/address/${contractAnalyzerAddress}\n`);
    ...
    console.log(`🔗 Explorer: https://testnet-explorer.electroneum.com/address/${contractTemplatesAddress}\n`);
    ...
    console.log(`🔗 Explorer: https://testnet-explorer.electroneum.com/address/${merkleProofAddress}\n`);
    ...
    console.log(`🔗 Explorer: https://testnet-explorer.electroneum.com/address/${merkleProofValidatorAddress}\n`);

    // Summary
    console.log("🎉 All contracts deployed successfully to ETN Testnet!");
    console.log("\n📋 Deployment Summary:");
    ...
    const deploymentPath = path.join(__dirname, "../deployments/etn-testnet.json");
    ...
    console.log("\n🔍 Verifying contracts on ETN Explorer...");
    try {
    ...
    console.log("\n🎯 Deployment to ETN Testnet Complete!");
    console.log("Next steps:");
    console.log("1. Update the frontend ABI files with new addresses");
    console.log("2. Test the contracts on ETN testnet");
    console.log("3. Update documentation with ETN addresses");
